...
<style>
	...
	#update-form>table {border : 1px solid white;  margin : auto;}
...
<body>
	 ...
	 <div id="outer">
			...
			<h2 id="h2" align="left">&nbsp;공지사항 수정</h2>
			<br>
			<form id="update-form" action="<%= contextPath %>/update.no" method="post">
				...
				<table align="center" border="1">
					<tr>
						<th>제목</th>
						<td><input type="text" name="noticeTitle" value="<%= n.getNoticeTitle() %>"  required></td>
					</tr>
					<tr>
						<th>내용</th>
						<td>
							<textarea name="noticeContent" rows="10" style="resize: none" required><%= n.getNoticeContent() %></textarea>
						</td>
					</tr>
