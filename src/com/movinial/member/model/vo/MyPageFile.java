...
public class MyPageFile {
	...
	public MyPageFile(int fileNo, int refNo, String originName, String changeName, String filePath, Date uploadDate,
	...
	public String toString() {
		return "MyPageFile [fileNo=" + fileNo + ", refNo=" + refNo + ", originName=" + originName + ", changeName="
